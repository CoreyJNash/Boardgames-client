...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://gentle-temple-31740.herokuapp.com/',
...
var createBoardgame = function createBoardgame(data) {
  return $.ajax({
...
var deleteGame = function deleteGame(boardgameId) {
  return $.ajax({
...
var boardGameEvents = __webpack_require__(15);
...
var bgapi = __webpack_require__(6);
var bgui = __webpack_require__(16);
var getFormFields = __webpack_require__(4);

var onCreateGame = function onCreateGame(event) {
    event.preventDefault();
    var data = getFormFields(event.target);
    bgapi.createBoardgame(data).then(bgui.onCreateSuccess).catch(bgui.onCreateFailure);
};

var onShowGames = function onShowGames(event) {
    event.preventDefault();
    // console.log('onShowGames ran!')
    bgapi.showGames().then(bgui.showGamesSucess).catch(bgui.showGamesFailure);
...
var onUpdateGame = function onUpdateGame(event) {
    ...
    bgapi.updateGame(data).then(bgui.updateGameSuccess).catch(bgui.failure);
};
...
var store = __webpack_require__(3);
var boardgameTemplate = __webpack_require__(17);
var bgapi = __webpack_require__(6);
...
var showGamesSucess = function showGamesSucess(data) {
  console.log(data);
  var htmltemplate = boardgameTemplate({ boardgames: data.boardgames });
  $('#show-games-list').html(htmltemplate);
  $('.delete').on('click', onDeleteGame);
  $('#message').addClass('hidden');
};

var onDeleteGameSucess = function onDeleteGameSucess() {
...
var onDeleteGame = function onDeleteGame(event) {
  event.preventDefault();
  var boardgameId = $(event.target).closest('ul').attr('data-id');
  // console.log("delete: " + boardgameId)
  bgapi.deleteGame(boardgameId).then(onDeleteGameSucess);
};
...
module.exports = {
  ...
  onDeleteGameSucess: onDeleteGameSucess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"show-wrapper\">\n<h1><b>"
    ...
    + "</h3>\n<h3>CREATOR: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.creator : stack1), depth0))
    + "</h3>\n<h3>GAME ID: "
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.boardgames : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
